...
C   MACHINE:  CRAY C916/256, J916/2048, HDS
C
C$$$
C
      INTEGER       IGDS  (*)
...
C       LENGTH = 178 LAT, LON GRIDS 37 TO 44
C
...
C$$     PROCESS POLAR STEREOGRAPHIC GRID TYPES
      ELSE IF (IGDS(3) .EQ. 5) THEN
        ...
        GDS(32) = CHAR(0)
      ENDIF
C      PRINT 101,(mova2i(GDS(IG)),IG=1,32)
C101    FORMAT ('  GDS= ',32(1X,i3))
C
